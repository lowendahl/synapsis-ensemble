...
| **Base truth** | A read-only file or folder registered in `workspace.yaml` `base_truths:` that voices treat as authoritative reference (brand book, doctrine, schema). |
